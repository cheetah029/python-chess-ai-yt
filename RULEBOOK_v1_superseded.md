> # ⚠️ SUPERSEDED — this is NOT the current rulebook
>
> This is the original **draft** ruleset, kept for history only. It does
> not describe the game as it is implemented or played today.
>
> **The authoritative rules are in [`RULEBOOK.md`](RULEBOOK.md)** (formerly
> `RULEBOOK_v2.md`), with the long-form version in
> [`docs/RULEBOOK_elaborated.md`](docs/RULEBOOK_elaborated.md) and a
> differences-from-standard-chess cheat sheet in
