...
- `RULEBOOK_v0.md` — original rules intact
...
2. **Implement Freeze+NR variant in RULEBOOK and code:**
   - Update `RULEBOOK_v0.md` with the modified manipulation restrictions
...
1. Update `RULEBOOK_v0.md` with the modified manipulation restrictions
